package com.primos.visitamoraleja.constantes;

public class Constantes {
	/**
	 * Tipo mime para los webview de las actividades
	 */
	...
	public final class Json {
		...
		public final static String IDS_CATEGORIAS_EVENTO = "ids_categorias_evento";
		public final static String IDS_ACTIVIDADES = "ids_actividades";
		...
		public final static String ZOOM_INICIAL = "zoom_inicial";
