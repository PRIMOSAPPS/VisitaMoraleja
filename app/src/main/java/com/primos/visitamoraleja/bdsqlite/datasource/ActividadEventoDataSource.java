...
public class ActividadEventoDataSource extends AbstractDataSource {
    ...
    public void deleteByIdEvento(long idEvento) {
        database.delete(ActividadEventoSQLite.TABLE_NAME, ActividadEventoSQLite.COLUMNA_ID_EVENTO
                + " = " + idEvento, null);
    }
    ...
    private ActividadEvento cursorToObject(Cursor cursor) {
        ...
        double latitud = cursor.getDouble(cursor.getColumnIndex(ActividadEventoSQLite.COLUMNA_LATITUD));
        double longitud = cursor.getDouble(cursor.getColumnIndex(ActividadEventoSQLite.COLUMNA_LONGITUD));
